...
#include <limits>
using namespace std;
#define V 7 //This creates a macro V with the value 7, used to represent the number of vertices in the graph.
...
void printMenu() {
    string print[10] = {
        ...
        "3: Play a Song",
        "4: Create a Playlist",
        "5: Recently Played Song",
        "6: View Most Played Songs",
        "7: Find Shortest Path to the Artist",
        "8: Display Song List",
        "9: Calculate World Tour Distance from Your Location"
    };
